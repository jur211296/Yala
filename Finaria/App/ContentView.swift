...
struct UserDataResetView: View {
    ...
    var body: some View {
                    ...
                    SectionBox(title: "Vaciar tus datos") {
                        VStack(alignment: .leading, spacing: 12) {
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                Text("Esta operación eliminará de forma permanente tus cuentas, transacciones, presupuestos, tipos de cambio, categorías y cualquier otro dato asociado a tu perfil de Finaria. Después del borrado, la app volverá a un estado similar al inicial.")
                                    .font(.footnote)
                                    .foregroundStyle(.secondary)
                            }
                            .padding(.horizontal, 16)
        ...
        .alert(
            ...
            Text("Esta acción es irreversible. Se eliminarán todas tus cuentas, transacciones, presupuestos, tipos de cambio y categorías. Después de esto, Finaria se reiniciará a un estado similar al inicial y no podrás recuperar tus datos.")
        }
