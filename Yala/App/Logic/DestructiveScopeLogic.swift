...
nonisolated enum DestructiveScopeLogic {
    ...
    /// Las 12 variantes visuales concretas de la hoja (una por operación × escenario). El callsite resuelve
    ...
    struct Model: Equatable {
        ...
        /// ¿Botón secundario "Ver mis grupos" (solo eliminar-cuenta con deuda)?
    ...
    static func model(
        ...
        case .deleteAccountCloud, .deleteAccountGroupsOnly:
            ...
            return Model(
                ...
                hasSecondaryAction: hasOutstandingDebt)
