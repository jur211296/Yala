...
- File: `Yala/Services/ExchangeRateAPIService.swift:75`
...
- Files:
  - `Yala/App/Views/Statistics/DetailContainerView.swift` (2 instances)
  - `Yala/App/Views/Import/ImportIntroSheet.swift` (7 instances)
  - `Yala/App/Views/Planning/Components/BudgetPeriodSelectorSheet.swift` (3 instances)
  - `Yala/App/Views/Profile/ProfileView.swift` (1 instance)
...
- Files:
  - `Yala/Services/ExchangeRateAPIService.swift` (3 prints)
  - `Yala/Services/BackgroundJobs.swift` (1 print)
  - `Yala/App/Views/Import/ImportIntroSheet.swift` (7 prints)
  - `Yala/App/Views/Statistics/DetailContainerView.swift` (4 prints)
...
- Files: `Yala/App/Views/Accounts/AccountFormView.swift`, `Yala/App/Views/Planning/BudgetEditorView.swift`
...
- Files and lines:
  - `Yala/App/Views/Statistics/TrendsTabView.swift` (1,193 lines)
  - `Yala/App/Views/Statistics/CategoriesTabView.swift` (1,188 lines)
  - `Yala/App/ViewModels/PanelViewModel.swift` (970 lines)
...
- File: `Yala/App/Views/Statistics/TrendsTabView.swift:87-130`
...
**App Initialization:**
- File: `Yala/App/YalaApp.swift:38`
...
**CSV Import Service:**
- File: `Yala/Utils/TransactionCSVImportService.swift` (733 lines)
...
**Budget Monitoring:**
- Problem: TODO in `Yala/Services/BackgroundJobs.swift:24`
- Status: Background task runs but doesn't check budget thresholds
- Current workaround: None
- Blocks: No proactive budget alerts

**Alias Functionality:**
- Problem: TODO in `Yala/App/Views/Profile/PersonalDetailsView.swift:214`
...
- File: `Yala/Utils/TransactionCSVImportService.swift`
...
- Files: `Yala/Services/ExchangeRateService.swift`, `Yala/Services/CurrencyConverter.swift`
...
- File: `Yala/Models/TransactionItem.swift`
...
- File: `Yala/App/YalaApp.swift:16-40`
...
- File: `Yala/Models/TransactionItem.swift:33`
