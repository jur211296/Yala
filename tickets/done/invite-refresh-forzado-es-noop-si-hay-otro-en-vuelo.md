...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - carrera de segundos en el primer arranque; RemoteConfigClientRefreshTests con mutante
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Es una carrera de segundos en el primer arranque. La cubre `RemoteConfigClientRefreshTests` con su mutante.
