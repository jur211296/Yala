...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - el rechazo del servidor casi no se da y se monta con SQL; ReverseClaimRejectionLogicTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). El rechazo del servidor casi no se da y cada caso se monta con SQL. Lo cubre `ReverseClaimRejectionLogicTests`.
