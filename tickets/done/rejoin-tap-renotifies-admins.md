...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - arreglo de servidor verificado con SQL contra el motor de produccion; tests del Worker
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). El arreglo es del servidor y ya se verificó con SQL contra el motor de producción (6 escenarios) y con los tests del Worker.
