...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - fuera del corte de hoy, pide admin y invitado; verificado de punta a punta en staging el 3-sep; RejectedMemberExitWiringTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Queda fuera del corte de hoy: pide un admin y un invitado con cuentas distintas. Se verificó de punta a punta contra staging el 3-sep y lo cubre `RejectedMemberExitWiringTests`.
