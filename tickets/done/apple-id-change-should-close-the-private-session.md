...
qa-status: absorbed
qa-date: 2026-09-16
qa-notes: Absorbido por device-qa-apple-id-change-closes-private-session, que sigue en qa con los dos Apple ID reales. Decision 1B aplicada, PR 159 y 168 en HEAD
---
...
No le queda código ni decisión: la pendiente se contestó con la opción 1B y los PR #159 (`075d5fe5e`) y #168
(`3e353a644`) están en HEAD. Su único criterio abierto, el device-QA, vive entero en
`device-qa-apple-id-change-closes-private-session` (caso principal, control de iCloud Drive, «Ahora no»,
Drive apagado, vuelta a la cuenta A, solo-grupos y celda D con bloqueo), que sigue en la cola de device.
