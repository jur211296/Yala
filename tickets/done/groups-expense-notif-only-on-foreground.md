...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - pide dos telefonos con cuentas distintas y el arreglo es de servidor
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Pide dos teléfonos con cuentas distintas, y el arreglo es del servidor (`eb6593ce`).
