...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - coste interno sin nada en pantalla; ForceFetchWaitBoxTests y mutantes
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Es coste interno sin nada que ver en pantalla. Lo cubren `ForceFetchWaitBoxTests` y sus mutantes.
