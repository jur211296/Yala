...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - caso de telefono heredado con 13 pasos, reinstalar y SQL; 18 mutantes en StorageMigrationIdentityGateLogicTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Es el caso del teléfono heredado de otra persona: 13 pasos con reinstalación y SQL en staging. Lo cubren 18 mutantes en `StorageMigrationIdentityGateLogicTests`.
