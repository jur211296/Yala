...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - 35 min creando y borrando cuentas reales; cubierto por ProviderMismatchLogicTests y WelcomeChooserUITests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Son unos 35 minutos creando y borrando cuentas reales para un caso poco frecuente (entrar con el proveedor que no es). Lo cubren `ProviderMismatchLogicTests`, `BeaconOrphanLogicTests` y `WelcomeChooserUITests`.
