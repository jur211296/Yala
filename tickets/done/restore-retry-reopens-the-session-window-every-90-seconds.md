...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - sin sintoma para el dueno; ciclos de 90 s; ICloudRestoreSignalTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). No tiene síntoma para el dueño de los datos y pide ciclos de 90 s. Lo cubre `ICloudRestoreSignalTests`.
