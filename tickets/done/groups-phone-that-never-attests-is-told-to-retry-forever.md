...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - solo un telefono sin App Attest y staging un dia en enforce; 25 mutantes
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Solo le pasa a un teléfono sin App Attest, y montarlo deja staging más de 24 h en `enforce`. Lo cubren 25 mutantes en `GroupsAttestVerdictLogicTests`.
