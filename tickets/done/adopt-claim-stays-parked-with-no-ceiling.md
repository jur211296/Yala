...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - pide dos iPhone y el caso del telefono reinstalado no se provoca a mano; cubierto por MigrationRunnerTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). El guion pide dos iPhone con el mismo Apple ID, y el propio ticket dice que el caso que arregla (un teléfono reinstalado) no se provoca a mano. Lo cubren `MigrationRunnerTests` y `ForwardStepCeilingLogicTests`.
