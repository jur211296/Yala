...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - fuera del corte de hoy, pide admin e invitado rechazado; GroupJoinReconcilerTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Queda fuera del corte de hoy: pide un admin y un invitado rechazado con cuentas distintas. Lo cubre `GroupJoinReconcilerTests`.
