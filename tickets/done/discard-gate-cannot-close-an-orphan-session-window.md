...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - el dueno legitimo no ve nada; pide un import de mas de 90 s y dos cuentas de nube
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). El dueño legítimo de los datos no ve nada distinto, y el montaje pide un import de iCloud de más de 90 s y dos cuentas de nube. Lo cubre `everyPathToTheDiscardGateClosesTheSessionWindow`.
