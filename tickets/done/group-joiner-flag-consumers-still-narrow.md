...
Simulador iPhone 17 Pro (iOS 26.5), sobre `2.1` @ `bebd57a57`, `Yala Dev`, `-uitest-seed grupos-sin-flag -uitest-icloud-identity` (quien se unió, sin la marca
local).

1. Nuevo gasto en el grupo: el formulario sale con **«Pagaste · partes iguales»** y ofrece el chip de Cuenta.
2. «QA joiner» de 90 con Cuenta Principal → éxito **«Pagado por Tú»**, cuenta Cuenta Principal.
3. Lista de grupos: la tarjeta dice «Te deben: S/ 45.00».
4. Registros, **sin relanzar**: «QA joiner» -90 en Cuenta Principal y +45 «Préstamo a grupos» en Grupos PEN.

Capturas: [gasto guardado](../../qa/evidencia-barrido-20260916/24-joiner-sin-flag-pagado-por-tu-cuenta-real.jpg) · [Registros](../../qa/evidencia-barrido-20260916/25-joiner-registros-cuenta-elegida-sin-relanzar.jpg).

**Límite del montaje:** la identidad sale del recordName de iCloud (seam), no del `sub` del servidor. El
recorrido con dos teléfonos reales es el de `groups-equal-split-shows-not-participating-on-peer`, que
sigue en la cola de device.
