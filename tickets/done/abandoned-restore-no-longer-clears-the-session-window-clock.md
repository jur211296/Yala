...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - exige un import de iCloud de mas de 90 s y esperas de minutos; lo cubren 8 mutantes en ICloudRestoreSignalTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Solo pasa con una descarga de iCloud de más de 90 s y esperas de varios minutos, y el dueño de los datos no ve nada distinto. Lo cubren ocho mutantes en `ICloudRestoreSessionSignalTests`.
