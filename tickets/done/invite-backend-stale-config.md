...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - en Yala Dev no puede salir y en produccion exige borrar el Yala de TestFlight; GroupInviteChannelRoutingLogicTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). En Yala Dev el fallo no puede salir, y para verlo en producción habría que borrar el Yala de TestFlight de tu iPhone. Las dos alertas ya se vieron en el simulador y lo cubre `GroupInviteChannelRoutingLogicTests`.
