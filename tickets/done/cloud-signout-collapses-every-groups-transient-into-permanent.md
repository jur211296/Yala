...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - exige provocar un 5xx del servidor, no se monta desde el iPhone; PausedChannelReasonWiringTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Exige que el servidor responda con un error 5xx a propósito, y eso no se monta desde el iPhone. Lo cubre `PausedChannelReasonWiringTests`.
