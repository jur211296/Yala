...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - sin sintoma para el dueno; descarga de mas de 10 min; ICloudRestoreSignalTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). El dueño de los datos no ve nada distinto, y montarlo pide una descarga de más de 10 minutos. Lo cubre `ICloudRestoreSignalTests`.
