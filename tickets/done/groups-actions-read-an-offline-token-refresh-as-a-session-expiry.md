...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - pide esperar sin red a que caduque el token, un segundo telefono y SQL; GroupsActionsOfflineTokenTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Hay que esperar sin red a que caduque la sesión (hasta una hora), con un segundo teléfono y SQL en staging. Lo cubre `GroupsActionsOfflineTokenTests`.
