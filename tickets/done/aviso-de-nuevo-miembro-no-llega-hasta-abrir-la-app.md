...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - exige dos telefonos con cuentas distintas y el arreglo es de servidor; test del gateway push.fanout
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Hacen falta dos teléfonos con cuentas distintas, y el arreglo vive en el servidor (`eb6593ce`), con su test en `gateway/test/push.fanout.unit.test.ts`.
