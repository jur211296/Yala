...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - el arreglo vive en produccion desde 2.0.4 y los casos a-c caben en simulador; tests ApplePayPendingStoreTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). El arreglo está en producción desde la 2.0.4 (`a3b68405`, julio) y los casos a–c ya se midieron en el simulador el 16-sep. Lo cubren `ApplePayPendingStoreTests` y `ApplePayAmountParserTests`.
