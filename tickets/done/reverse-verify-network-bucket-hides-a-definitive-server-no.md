...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - pide un 403 del servidor en el momento justo y 15 min; MigrationRunnerTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Pide que el servidor responda 403 justo en la comprobación y esperar 15 minutos. Lo cubre `MigrationRunnerTests`.
