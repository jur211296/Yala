...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - ventana de 10 a 15 min con consola, SQL y dos cuentas; CloudPersonalAttestSignOutTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Solo sale en una ventana muy precisa de 10 a 15 minutos, con la consola de Xcode, SQL en staging y dos cuentas. Lo cubre `CloudPersonalAttestSignOutTests`.
