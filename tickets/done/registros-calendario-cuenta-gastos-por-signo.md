...
Simulador iPhone 17 Pro (iOS 26.5), sobre `2.1` @ `bebd57a57`, `Yala Dev`, `-uitest-seed-desync`.

1. Registros: chip Gasto **S/ 300.00**, Ingreso 500. En el calendario, la celda de hoy dice **«300»** y
   VoiceOver lee «16 de setiembre, S/ 300.00»: la celda y el chip cuentan lo mismo.
2. Borrar el gasto de -500 (Restaurantes): el chip pasa a **S/ -200.00** y la celda queda **sin cifra**,
   con VoiceOver «Sin registros este día». Es el residual que el owner decidió el 2026-09-02.

Capturas: [celda = chip](../../qa/evidencia-barrido-20260916/18-calendario-celda-300-igual-chip.jpg) · [solo reembolso](../../qa/evidencia-barrido-20260916/19-calendario-solo-reembolso-sin-barra.jpg).

Visto de paso, sin ticket nuevo: el hero del Panel suma magnitudes (700 / 700) donde Registros neta
(500 / 300 / 200). Ya está en backlog: `records-standalone-amount-discrepancy`.
