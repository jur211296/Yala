...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - nada visible, es rendimiento del arranque; FXRepairQueueTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). No hay nada que ver en pantalla: es rendimiento del arranque y un canario. Lo cubren `FXRepairQueueTests` y `FXRepairQueueOutboxTests`.
