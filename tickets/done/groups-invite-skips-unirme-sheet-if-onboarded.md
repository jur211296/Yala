...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - pide el enlace de un grupo de otra cuenta; GroupInviteSheetAlwaysShownTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Pide el enlace de un grupo de otra cuenta. Lo cubre `GroupInviteSheetAlwaysShownTests`, y la hoja lleva en tu iPhone desde el build 13.
