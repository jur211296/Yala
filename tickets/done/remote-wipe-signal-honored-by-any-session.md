...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - pide dos aparatos con el mismo Apple ID; RemoteWipeSignalWiringTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Pide dos aparatos con el mismo Apple ID. Lo cubre `RemoteWipeSignalWiringTests`.
