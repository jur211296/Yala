...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - pide dos telefonos; la causa esta arreglada con red en GroupDetailIdentityConsumerTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Pide dos teléfonos. La causa está arreglada (`5ca4dd47`) y la cubren `GroupDetailIdentityConsumerTests` y `GroupExpenseAmountResolverTests`.
