...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - no es nube ni restaurar, sin guion de device y visto parcial en simulador; CurrencyConverterPartialRateTests
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). No toca nube ni restaurar, no tiene guion de iPhone escrito y ya se vio en parte en el simulador. Lo cubre `CurrencyConverterPartialRateTests`.
