...
qa-date: 2026-09-23
qa-notes: barrido 2026-09-23 sin device-QA - solo le pasa a un telefono sin App Attest y pide rotar el secreto de staging y 24 h
---
...
Sale de la cola de device-QA por el barrido que pidió Jürgen el 2026-09-23 (encargo `2026-09-23-barrido-qa-in-qa-pre-device`). Solo le pasa a un teléfono sin App Attest, y el iPhone sí lo tiene. Montarlo exige el simulador, rotar el secreto de staging y esperar 24 h.
