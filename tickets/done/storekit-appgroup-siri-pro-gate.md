...
## QA Visual · 2026-09-16 — PASS (pasos 1 y 2)

Simulador iPhone 17 Pro (iOS 26.5), sobre `2.1` @ `bebd57a57`, `Yala Dev` **sin** `-uitest`, instalación real (onboarding en PEN).

**Corrección medida al guion de arriba:** la tarjeta del atajo de la app («Anotar con Siri» en la
sección de Yala Dev de Atajos) **no corre en simulador**. `linkd` rechaza la app —«Unable to get teamId»,
«Couldn't find AppShortcutsProvider»— porque el build del simulador no lleva firma de equipo. Lo que sí
corre: Atajos → Crear atajo → acción «Anotar con Siri» de Yala Dev → Texto → reproducir.

| Estado | `isProUser` en el App Group | Texto | Respuesta |
|---|---|---|---|
| Free, de fábrica | `false` (plist) | «Cafe 5» | **«Activate Yala Pro to use Siri entry.»** |
| «Simular Pro» ON | `true` (plist y log `Dev Pro tier ON`) | «Cafe 5» | «I didn't understand…»: ya pasó la puerta; sin LLM no entiende el texto |
| «Simular Pro» ON | `true` | «Cafe 25» | **«Borrador básico creado: Cafe 25. Completa los detalles en tu bandeja.»** · PEN -25.00 |

Al abrir Yala Dev, la Bandeja tiene «Cafe 25 · Falta: Cuenta, Subcategoría». La puerta Pro lee bien el
flag que escribe la app. No se ejerció la voz real, que llega al mismo `perform()`.

Capturas: [Free](../../qa/evidencia-barrido-20260916/34-siri-free-pide-pro.jpg) · [Pro, no entiende](../../qa/evidencia-barrido-20260916/35-siri-pro-pasa-la-puerta-no-entiende-texto.jpg) · [Pro, borrador](../../qa/evidencia-barrido-20260916/36-siri-pro-borrador-creado-en-espanol.jpg) · [Bandeja](../../qa/evidencia-barrido-20260916/37-siri-pro-borrador-en-bandeja.jpg).

**Hallazgo, con ticket propio:** con el iPhone en español (es-PE), las respuestas de error del atajo salen
en inglés y la de éxito en español → `siri-shortcut-error-replies-speak-english-on-a-spanish-iphone`.
