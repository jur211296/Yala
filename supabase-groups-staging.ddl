...
--   §6 g8_01_push_fanout          — APNs fan-out support: get_group_push_tokens (co-member ACTIVE tokens, caller
--                                   excluded) + prune_push_token (exact pair, shared-active-group radius guard).
...
--   gain a p_key text argument) + g8_01_push_fanout. The G7 changes are woven IN-PLACE into §1–§4 plus the new §5.
...
-- ============================================================================================
-- §6 — g8_01_push_fanout (2026-07-16): RPCs de soporte del fan-out APNs (verbatim de la migración)
-- ============================================================================================
