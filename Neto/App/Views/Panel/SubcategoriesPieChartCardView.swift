//
//  SubcategoriesPieChartCardView.swift
//  Neto
//
...
struct SubcategoriesPieChartCardView: View {
    ...
    private func processChartData() -> [PieChartData] {
        // Limit to top 9 subcategories + "Restante"
        let maxVisible = 9
        ...
        if validSubcategories.count <= maxVisible {
            ...
            let top = validSubcategories.prefix(maxVisible)
