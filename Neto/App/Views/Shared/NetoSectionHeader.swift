...
struct NetoSectionHeaderCompact: View {
    let title: String
    let count: Int?
...
#Preview {
    VStack(alignment: .leading, spacing: 30) {
        // Standard header
        NetoSectionHeader("Categorías", actionTitle: "Ver todas") { }
        ...
        // Without action
        NetoSectionHeader("Configuración")

        Divider()

        // Compact headers
        NetoSectionHeaderCompact("Activas", count: 12)
        NetoSectionHeaderCompact("Archivadas")
    }
    .padding()
