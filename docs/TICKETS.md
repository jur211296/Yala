...
| aviso-de-nuevo-miembro-no-llega-hasta-abrir-la-app | backlog | tickets/backlog/aviso-de-nuevo-miembro-no-llega-hasta-abrir-la-app.md |
...
| ci-verde-con-la-suite-en-rojo | backlog | tickets/backlog/ci-verde-con-la-suite-en-rojo.md |
...
| registros-calendario-cuenta-gastos-por-signo | backlog | tickets/backlog/registros-calendario-cuenta-gastos-por-signo.md |
