...
| R10 | Grupo MIGRADO en device fresco: FKs del historial (namespace CloudKit) vs ids born-remote (namespace backend) no matchean ⇒ balances rotos (hallazgo G3 2026-07-15, ver corrección §2 y §9.3d) | decidir en G6: derivación namespace-aware en `applyMember` o remap de FKs en el uploader del owner; devices con members preexistentes NO afectados (la adopción dual-match de G3 conserva el id CloudKit-era) |
