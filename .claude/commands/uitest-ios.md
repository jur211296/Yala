...
!`xcodebuild -scheme Yala -destination 'platform=iOS Simulator,name=iPhone 17 Pro' test -only-testing:YalaUITests 2>&1 | grep -E "(Test Suite|fail|error:|warning:|BUILD SUCCEEDED|BUILD FAILED)" | head -120`
