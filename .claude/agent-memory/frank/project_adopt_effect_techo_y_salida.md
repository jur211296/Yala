...
`welcome-adopt-effect-failure-has-no-reason-and-no-cancel` (texto y «Cancelar» en el Welcome) y
`adopt-exit-keeps-the-session-it-opened` (¿cerrar la sesión al salir del adopt? tampoco lo hace el claim de #221). Los
