...
`https://yala-pu9mi3md5-jur211296s-projects.vercel.app`. Canvas de las dos direcciones:
...
- Autorizó capturas nuevas del simulador con semilla y cambiar el nombre de usuario; no hicieron falta.
...
- **Tema del sistema por defecto** (antes siempre oscuro): script del `<body>` en `Layout.astro`.
