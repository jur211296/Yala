...
struct BalanceHelperTests {
    ...
    // NOTA: tests de totalBalance/displayedBalance migrados a
    // LiveBalanceCalculatorTests (12 tests con cobertura más amplia
    // incluyendo casos multi-divisa con TC actual).
