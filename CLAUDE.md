...
| ScheduledPaymentsViewModel, ProfileViewModel | — |
| RecordsFiltersViewModel, BudgetEditorViewModel | — |
| DetailContainerViewModel, CategoryDetailViewModel | — |
| AccountFormViewModel, AccountSelectorViewModel | — |
| SubcategorySelectorViewModel, TagSelectorViewModel | — |
| + 18 ViewModels más en App/ViewModels/ | — |

### Test Suites (8)
FilterServiceTests, CalculatorTests, TagTests, TrendProcessingTests, TrendGroupingTests, NewTransactionViewModelTests (35), BudgetsViewModelTests (11), InboxViewModelTests (10)
